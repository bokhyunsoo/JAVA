...
//	public EmpManage() { //생성자
//		dao=new EmpDAO();
//	}
	void delete(){
		Scanner scan=new Scanner(System.in);
// print() 줄바꿈을 하지 않음, println() 출력 후 줄바꿈		
...
//Date.valueOf(문자열) : 문자열을 날짜로 변환	
// "2017-11-01"		
		EmpDTO dto=new EmpDTO(empno, ename, 
				Date.valueOf(hiredate), sal);
		dao.insertEmp(dto);
